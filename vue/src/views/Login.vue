<template>
  <div class="wrapper">
    ...
    <div
        style="margin: 150px auto; background-color: #fff; width: 450px; height: 340px; padding: 20px; border-radius: 10px">
        <div style="margin: 20px 0; text-align: center; font-size: 28px">
            <b>驾驶员异常行为分析系统</b>
        </div>
...
.wrapper {
  height: 100vh;
  background-image: linear-gradient(to bottom right, #42b983, #1E90FF);
  overflow: hidden;
}
</style>
