<template>
  ...
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
              @selection-change="handleSelectionChange" style="align-content: center;text-align: center" align="center">
      ...
      <el-table-column prop="user" label="发布人" align="center"></el-table-column>
    ...
    <el-dialog title="通知" :visible.sync="dialogFormVisible" width="60%" >
    ...
    <el-dialog title="通知" :visible.sync="viewDialogVis" width="60%" >
      <el-card>
        <div>
          <mavon-editor
              class="md"
...
export default {
  ...
  methods: {
    ...
    del(row) {
      this.request.delete("/article/" + row.id).then(res => {
          if (res.code === '200') {
