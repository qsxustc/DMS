...
<!--      <el-input style="width: 200px" placeholder="请输入角色" suffix-icon="el-icon-position" class="ml-5" v-model="role">-->
        <el-select clearable v-model="role" placeholder="请选择角色" >
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="driveyear" label="驾龄"></el-table-column>
